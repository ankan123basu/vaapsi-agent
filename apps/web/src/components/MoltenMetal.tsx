...
export default function MoltenMetal({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("WebGL2 context initialization failed for MoltenMetal:", e);
      return;
    }
  ...
  useEffect(() => {
    ...
    mouseStrength, opacity, prefersReducedMotion
  ]);
  ...
  if (prefersReducedMotion) {
    return (
      <div
        ...
        style={{
          background: `radial-gradient(circle, ${color3} 0%, ${color2} 50%, ${color1} 100%)`
        }}
      />
    );
  }
